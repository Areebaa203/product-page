  ...
  return (
    <section className="w-full bg-white">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-10 md:px-8">
        {/* CARD */}
        <div
          className="mt-16 relative rounded-2xl bg-[#F3DBF6]/60 min-h-[220px] font-inter overflow-hidden"
          style={{ fontFamily: "Inter, system-ui, sans-serif" }}
        >
          {/* CONTENT WRAPPER */}
          <div className="relative z-10 grid gap-6 px-4 py-10 md:grid-cols-2 md:px-10">
            {/* LEFT */}
            <div>
              <h1 className="text-xl font-bold font-inter leading-snug text-slate-700 sm:text-2xl md:text-3xl">
